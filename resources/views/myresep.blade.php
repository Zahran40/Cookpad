    ...
    <div class="container mt-5">
        ...
        <div class="row">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="card-body">
                            <a href="{{ route('resep') }}" class="card-text"
                                style="color: inherit; text-decoration: none;">Opor Ayam Pejantan</a>
            ...
            <div class="text-center mt-5" style="margin-bottom: 80px;">
                ...
                <img src="https://global-web-assets.cpcdn.com/assets/empty_states/no_results-8613ba06d717993e5429d9907d209dc959106472a8a4089424f1b0ccbbcd5fa9.svg"
