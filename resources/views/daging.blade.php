...
<body>
  ...
  <div class="container">
    ...
    <div class="mb-4">
      ...
      <div>
        <h4 class="mt-4">Resep Daging Sapi <span class="text-muted">(101)</span></h4>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <div class="card">
          <div class="d-flex">
            ...
            <div class="card-body">
              <a href="{{ route('resep') }}" class="card-text" style="color: inherit; text-decoration: none;">Ayam
                kecap</a>
      ...
      <div class="col-12 mb-4">
        <div class="card">
          <div class="d-flex">
            <img
              src="https://img-global.cpcdn.com/recipes/4c3542fb420b32d2/130x160f0.5_0.562115_1.0q50/ayam-woku-foto-resep-utama.webp"
              class="img-fluid" style="max-width: 150px; object-fit: cover;" alt="Ayam Woku">
            <div class="card-body">
              <a href="../Resep/resep.html" class="card-text" style="color: inherit; text-decoration: none;">Ayam
                Woku</a>
              <p class="card-texts">ayam • Bahan: daun bawang, potong 2 • daun kemangi (me: suka yg banyak krn makin
                wangi nantinya) • Bumbu halus: bawang merah • bawang putih • cabai merah keriting ...</p>
      ...
      <div class="col-12 mb-4">
        <div class="card">
          <div class="d-flex">
            <img
              src="https://img-global.cpcdn.com/recipes/0bb5a96e36739e2a/130x160f0.5_0.413471_1.0q50/ayam-bakar-kecap-foto-resep-utama.webp"
              class="img-fluid" style="max-width: 150px; object-fit: cover;" alt="Ayam Bakar Kecap">
            <div class="card-body">
              <a href="../Resep/resep.html" class="card-text" style="color: inherit; text-decoration: none;">Ayam bakar
                taliwang</a>
              <p class="card-texts">ayam, potong 10 • Gula Aren • Kecap Manis • Gula, Garam, Penyedap Rasa • air •
                Bawang Merah • bawang putih • kemiri • kunyit • jahe • serai • daun salam</p>
    ...
    <div class="container my-4 mt-5">
      ...
      <p style="font-size: 20px;">
        Cookpad adalah platform yang memungkinkan pengguna untuk berbagi dan menemukan resep masakan dari seluruh dunia.
        Dengan fokus pada komunitas, Cookpad menyediakan ruang bagi para koki rumahan untuk berinteraksi, berbagi
        pengalaman, dan menemukan inspirasi masakan baru.
