...
<body>
    ...
    <div class="container">
        ...
        <div class="mb-4">
            ...
            <div>
                <h4 class="mt-4">Resep Udang <span class="text-muted">(90)</span></h4>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="d-flex">
                        <img src="{{ $resep->gambar_resep }}"
                            class="img-fluid" style="max-width: 150px; object-fit: cover;" alt="{{ $resep->nama_resep }}">
                        <div class="card-body">
                            <a href="{{ route('resep.show',$resep->id) }}" class="card-text"
                                style="color: inherit; text-decoration: none;">{{$resep->nama_resep}}</a>
                            <p class="card-texts">{{ $resep->bahan }}</p>
                            </p>
                            <p class="text-muted">{{$resep->waktu_pembuatan}}</p>
                        </div>
                    </div>
                </div>
            </div>
